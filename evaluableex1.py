...
planeta = str(input("Introduzca un cuerpo celeste a elegir de los propuestos dentro del paréntesis (mercurio, venus, tierra, marte, júpiter, saturno, urano, neptuno, plutón, luna, sol):"))
